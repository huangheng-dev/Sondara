...
- 非公开的公司资料、客户名单、联系人、邮件正文、销售金额、跟进记录和内部知识库
...
确认暂存区没有 `data/`、`.env`、数据库、备份、导出、日志、截图或登录状态文件，再创建提交。公开种子中的客户、联系人、消息和经营数字必须明确标记为虚构；项目所有者自己的公开品牌资料可以引用官方网站，但必须注明来源，不得混入未公开资料或第三方个人信息。
